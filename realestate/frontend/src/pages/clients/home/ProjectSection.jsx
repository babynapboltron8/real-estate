...
import Sustainable from "/src/assets/sustainable_living.jpg";
  ...
  const projects = [
    {
      ...
      imageUrl: Modern, // Replace with your project image URL
    },
    {
      title: "Urban Oasis",
      description:
        "A cutting-edge urban retreat designed to harmonize with the bustling cityscape.",
      imageUrl: UrbanOasis, // Replace with your project image URL
    },
    {
      title: "Sustainable Living",
      description:
        "Embrace eco-friendly living with our sustainable residential project.",
      imageUrl: Sustainable, // Replace with your project image URL
    },
  ];
