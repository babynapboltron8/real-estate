...
const AddUser = () => {
  ...
  // Sample roles and positions
  const roles = ["Admin", "Agent"];
  // const positions = ["CEO", "Manager", "Agent"];
  ...
  const fetchUserById = () => {
    // Implement logic to fetch user data from your API or state
    // Example:
  ...
  const updateExistingUser = () => {
    // Implement logic to update user data using your API or state
    // Example:
  ...
  const addNewUser = () => {
    // Implement logic to add a new user using your API or state
    // Example:
