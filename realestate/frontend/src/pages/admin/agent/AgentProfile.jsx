...
const AgentProfile = () => {
  ...
  // Replace this with actual data fetching logic for a single agent based on the agentId
  const agentDetails = {
    id: agentId,
    name: "John Doe",
    ...
    profileImage: "/src/assets/MyAvatar.png", // Add the path to your agent's profile image
    sales: [
      {
        id: 1,
        date: "2023-01-15",
  ...
  const calculateMonthsToClaim = () => {
    // Replace this with actual logic to calculate months to claim
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <main className="flex-1 overflow-x-hidden overflow-y-auto py-8 px-12">
          ...
          <div className="bg-white p-8 rounded-md shadow-lg">
                  ...
                  {agentDetails.sales.map((sale, index) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-6">
                        <Link to={`/admin/client-sales-info`}>
                          {clients.find((c) => c.id === sale.clientId)?.name}
                        </Link>
                      </td>
                      <td className="py-3 px-6">
                        <Link to={`/admin/lot-sales-info`}>
                          {sale.lotNumber}
                        </Link>
                      </td>
                    </tr>
            ...
            {/* Add more sections for agent details as needed */}
          </div>
        </main>
      </div>
    </div>
