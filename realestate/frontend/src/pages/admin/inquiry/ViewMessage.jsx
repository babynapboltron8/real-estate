...
const ViewMessage = () => {
  //   const { messageId } = useParams(); // Extract messageId from URL params
  const [message, setMessage] = useState({
    ...
    source: "Email",
    from: "John Doe", // Added the name of the person who inquired
  });
  ...
  const handleSubmitReply = (e) => {
    e.preventDefault();
    // Handle the logic to submit the reply (e.g., send it to the server)
    console.log("Reply submitted:", reply);
    // For demonstration purposes, update the local state with the reply
