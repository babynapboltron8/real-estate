import ManageAccountSidebar from "./components/manage-account-sidebar";
...
export default function Page() {
  ...
  const clientDetails = {
    ...
    profileImage: "/images/myAvatar.png", // Add the path to your profile image
  };
            ...
            {clientDetails.lots.map((lot, lotIndex) => (
              <div key={lotIndex} className="mb-4">
                ...
                <div className="mt-4">
                  ...
                  <p>
                    Total Balance: {calculatePaymentSummary([lot]).totalBalance}
                  </p>
                  <p>
