      ...
      <div className="flex flex-col items-center h-full">
        ...
        <nav className="w-full px-12 pt-6">
          <ul className="space-y-2">
            ...
            >
              <SidebarLink label="All Clients" to="/admin/client" />
              <SidebarLink label="Add Client" to="/admin/addclient" />
            </SidebarDropdown>
            ...
            >
              ...
              <SidebarLink label="Add Agent" to="/admin/addagent" />
            </SidebarDropdown>
            {/* Map Dropdown */}
            <SidebarDropdown
              label="Map & Lot"
            ...
            >
              ...
              <SidebarLink label="Add Map" to="/admin/addmap" />
            </SidebarDropdown>
            {/* Users Dropdown */}
            <SidebarDropdown
              label="Users"
            ...
            >
              ...
              <SidebarLink label="Add User" to="/admin/adduser" />
            </SidebarDropdown>
            ...
            >
              <SidebarLink label="Price List" to="/admin/pricelist" />
              <SidebarLink label="Add Price List" to="/admin/addpricelist" />
            ...
            >
              ...
              <SidebarLink label="Add Project" to="/admin/addproject" />
            </SidebarDropdown>
            ...
            >
              <SidebarLink label="All Inquiry" to="/admin/inquiries" />
              <SidebarLink label="Add Contact" to="/admin/addcontact" />
            </SidebarDropdown>
          </ul>
          <div className="mt-4">
